class CookieHelper {
    ...
    /**
     * 쿠키를 저장한다. 저장시 이름과 값은 내부에서 urlencoding 처리 한다.
    ...
    setCookie(name, value, option = {}) {
        ...
        if (option.expries instanceof Date) {
            option.expries = option.expries.toUTCString();
        }
    ...
    getCookie(name) {
        ...
        // 반환할 값이 없다면 decoding을 수행하고 없다면 undefined를 반환함
