...
/** 3) or  */
// --> 하나라도 참이 포함되어 있따면 결과는 참
console.group("3) or");
console.log(true || true);  //true
console.log(true || false);  //true
console.log(false || true);  //true
console.log(false || fasle);  //false
console.groupEnd();
...
let k = 1;
console.log(!k); //숫자 1은 true에 대응되므로 not true

let k = 0;
console.log(!1); // 숫자 0은 false에 대응되므로 not false -> true
