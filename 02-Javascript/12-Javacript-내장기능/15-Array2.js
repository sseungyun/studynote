...
// 발견하지 못했으면 -1을 반환한다.
console.log( arr.indexOf(null) ); // -1          //!!! 몇번째에 있는 검색하려면 index 있는지 없는지만 보려면 include
...
// 주어진 판별함수를 만족하는 첫번째 값을 반환한다. 못찾겠으면 undefined를 반환한다.
