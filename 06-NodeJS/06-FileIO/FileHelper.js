 ...
 * @Description: 파일, 폴더 차리 관련 유틸리티 함수 구현
 * @Author : EZEN 아카데미 Node.js 강의 (신승윤 , gsh05144@naver.com)
 */

import fs from 'fs';
import {join} from 'path';

const mkdir = (target, Permission='0755') => {
    // 경로가 없다면 수행하지 않는다.
    ...
    // 윈도우의 경우 하드디스크 문자열을 구분하기 위해 ":"이 포함되어 있따.
