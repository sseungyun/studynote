...
const url = 'http://itpaper.co.kr/data/simple_texr.txt';

/** (3) async/await 방식을 즉기 실행 함수 형태로 정의 */
(async () => {
    let result = null;
    ...
    try {
        ...
        // 정상적으로 처리에 성공한 경우 promise 방식의 첫 번째 then 역활은 이 위치에서 자연스럽게 코드가 이어진다.
    ...
    // promise 방식의 마지막 then 은 뒷부분에 일반 코드로 작성한다.
