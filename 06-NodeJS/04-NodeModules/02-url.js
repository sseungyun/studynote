...
//URL의 각 성분을 분해 -- > javascript의 loaction객체와 동일한 기능
const loaction = new URL(myurl);

console.group("URL 성분 정보 확인")
console.debug(loaction);
console.debug('href: ' + loaction.href);
console.debug('protocal: ' + loaction.protocol); // 통신방식 (http:, https:)
