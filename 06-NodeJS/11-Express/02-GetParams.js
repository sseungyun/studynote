...
// public/02_get_parmas_by_link.html
// public/02_get_parmas_by_form.html
// public/02_get_parmas_by_js.html
...
router.get('/send_url/:username/:age', (req, res, next) => {
    ...
    const html = "<h1><span style='color:#0066ff'>" + req.params.username + "</span>님은 < style='color:#ff6600'>" + req.params.age + '</span>세 입니다.</h1>';        
