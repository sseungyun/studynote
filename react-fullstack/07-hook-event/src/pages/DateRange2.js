  ...
  switch (action) {
    ...
    default:
      ...
      break;
            ...
            //state의 모든 값을 가져온 후 sdate값을 startDate값으로 바꾼 후 return하면 결과가 myDate로 반환되어 화면에 출력된다. 
...
const DateRange2 = () => {
  ...
  return (
    <div>
      ...
      <p>                                         {/** 이 setMyDate값들이 setDateValue에 action값으로 전달된다. */}
