...
import DepartmentPath from "./pages/DepartmentPaht";
    ...
    <div>
       ...
       <Routes>
         ...
         {/* Path 파라미터는 URL 형식에 변수의 위치와 이름을 정해줘야 한다. 
                  경로를 붙힐 때 앞에 :id 처럼 콜론을 붙히면 변수로 인식한다. */}
         <Route path="/department_path/:id/:msg" element={<DepartmentPath/>} />
          {/* Path 속성 없이 Route 지정 -> 지정되지 않은 모든 요청에 반응. 단 Route블록의 맨 마지막에 배치해야 함.  */}
