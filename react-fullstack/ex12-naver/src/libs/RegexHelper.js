...
*/
  ...
  /**
    * 한글과 영문 대소문자로만 이루어 졌는지 검사하기 위해 field()를 간접적으로 호출한
    다.
    * @param {string} field 검사할 대상의 CSS 선택자
    * @param {string} msg 표시할 메시지
    */
  korEng(field, msg) {
    return this.noSpaceField(field, msg, /^[a-zA-Zᄀ-ᄒ가-힣]*$/);
  }
  /**
    * 영문 소문자, 숫자와 특수기호(_) (-) 로만 이루어 졌는지 검사하기 위해 field()를 간
    접적으로 호출한다.
    * @param {string} field 검사할 대상의 CSS 선택자
    * @param {string} msg 표시할 메시지
    */
  ...
  /**
    * 영문, 숫자와 특수기호로만 이루어 졌는지 검사하기 위해 field()를 간접적으로 호출
    한다.
    * @param {string} field 검사할 대상의 CSS 선택자
    * @param {string} msg 표시할 메시지
    */
